function [oscillating,synchr_index, tConv, in_freq_absPower,delayPh]=solverODEvarInput2(plotflag, par, phase, elegance)
...
if elegance
    [t,x]=ode45(@modelFunqESDvarInputPhase,tRange,x_ini,options,parameters{:});
else
...
if elegance
    [t,y]=ode45(@modelFunqESDvarInputPhase,tRange,x_ini,options,parameters{:});
else
